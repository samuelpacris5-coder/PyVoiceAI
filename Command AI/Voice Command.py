...
speak("Hi im Sam your personal AI assistant,  im using your computer at")
print("Hi im Sam your personal AI assistant,  im using your computer at")
...
def send_mail():
    ...
    server.login('samuelp@gmail.com', 'yrprldhxjaogwiey')
